...
public class TranslationUtils {
	...
	public static final String TRANLATE_APP_ID = "20181114000234463";
	public static final String SECURITY_KEY = "o1DwKFwajLS5YARGWnOp";
	...
	public static String translate(String source) throws UnsupportedEncodingException {
		...
		String url = "http://api.fanyi.baidu.com/api/trans/vip/translate?q=KEYWORD&from=auto&to=auto&appid=APPID&salt=SALT&sign=SIGN";
		...
		for (int i = 0; i < transResult.size(); i++) {
			...
			stringBuilder.append("翻译的内容为(" + fromLanguage + "):\n" + transSrc + "\n");
			stringBuilder.append("翻译的结果为(" + toLanguage + "):\n" + transDis + "\n");
		}
